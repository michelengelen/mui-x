...
describe('<DataGrid /> - Filter', () => {
  ...
  describe('column type: singleSelect', () => {
    ...
    it('should filter with operator "isNotAnyOf"', () => {
      ...
      ).to.deep.equal(ALL_ROWS_COUNTRY.filter((v) => v !== 'United States'));
      expect(
      ...
      // With object options
      expect(
        getRows({ field: 'year', operator: 'isNotAnyOf', value: [1974] }).year,
      ).to.deep.equal(ALL_ROWS_YEAR.filter((v) => v !== 'Year 1974'));
