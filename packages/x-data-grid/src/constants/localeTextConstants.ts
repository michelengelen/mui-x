...
export const GRID_DEFAULT_LOCALE_TEXT: GridLocaleText = {
  ...
  filterOperatorDoesNotStartWith: 'does not start with',
  filterOperatorEndsWith: 'ends with',
  filterOperatorDoesNotEndWith: 'does not end with',
  filterOperatorIs: 'is',
  ...
  headerFilterOperatorDoesNotStartWith: 'Does not start with',
  headerFilterOperatorEndsWith: 'Ends with',
  headerFilterOperatorDoesNotEndWith: 'Does not end with',
